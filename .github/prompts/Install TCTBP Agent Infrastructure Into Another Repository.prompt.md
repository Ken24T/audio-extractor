...
The current source repository is the source of generic workflow logic.
...
- leave references instructing the target repo to depend on the current source repo at runtime
